...
final class Mediator extends AbstractMediator
{
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function getContainer(Request $request, Response $response, array $params = []): Response
    {
        // View must exist
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function getPhpIni(Request $request, Response $response, array $params = []): Response
    {
        // View must exist
        if (is_null($this->pView)) {
            throw new \RuntimeException('The view is missings.');
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function getPhpInfo(Request $request, Response $response, array $params = []): Response
    {
        // View must exist
        if (is_null($this->pView)) {
            throw new \RuntimeException('The view is missings.');
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function getOpCache(Request $request, Response $response, array $params = []): Response
    {
        // View must exist
        if (is_null($this->pView)) {
            throw new \RuntimeException('The view is missings.');
