...
/*************************************************************************
 * file encoding: UTF-8
 * description: draw the contacts per year graph
 *         GET: op2=interval
 ...
 *************************************************************************/
     ...
     **********************************/
    require(PBR_PATH.'/includes/db/function/contactsyearcount.php');
    $tRecordset = ContactsYearCount( CAuth::GetInstance()->GetUsername()
