...
/*************************************************************************
 * file encoding: UTF-8
 * description: draw the rents per month graph
 *         GET: op2=interval
 ...
 *************************************************************************/
     ...
     **********************************/
    require(PBR_PATH.'/includes/db/function/rentsmonthcount.php');
    $tRecordset = RentsMonthCount( CAuth::GetInstance()->GetUsername()
